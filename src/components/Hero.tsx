  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
        ...
        {/* TAGLINE ON NEW LINE */}
        <span className="block mt-2 mx-auto text-[#D9B42C] font-semibold tracking-wide text-3xl md:text-3.5xl typing">
      ...
      Designed for productivity and built for growth.
        ...
        <Button
          ...
          className="bg-[#2C4A3D] hover:bg-[#848A36] text-white text-lg px-10 py-6 h-auto shadow-lg hover:shadow-xl transition-all rounded-xl"
        >
          Book a Tour →
        </Button>
